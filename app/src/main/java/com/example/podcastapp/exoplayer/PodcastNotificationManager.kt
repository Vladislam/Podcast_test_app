...
import com.example.podcastapp.util.consts.Constants.NOTIFICATION_CHANNEL_ID
...
class PodcastNotificationManager(
    ...
    init {
        ...
        notificationManager = createNotificationManger(mediaController, notificationListener)
    }
